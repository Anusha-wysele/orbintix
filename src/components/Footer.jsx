        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-16">
          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-10">
            <Link to="/" className="text-3xl font-black tracking-tighter flex items-center gap-3 group">
              <div className="w-10 h-10  bg-[#FFC107] flex items-center justify-center text-primary font-black text-2xl transition-all duration-500 group-hover:rotate-12 group-hover:shadow-[0_0_20px_rgba(0,191,255,0.4)]">
                O
              </div>
              <div className="flex flex-col leading-none">
                <span className="text-white">ORBINTIX</span>
                <span className="text-accent text-[10px] tracking-[0.4em] mt-1">TECHNOLOGIES </span>
              </div>
            </Link>
